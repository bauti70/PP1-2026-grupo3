...
| **Descripción** |permite anfrition cargar una nueva propiedad al sistema para que este disponible para alquiler |
| **Precondiciones** |el anfrition debe haber iniciado sesion y su perfil verificado|
| **Postcondiciones (criterios de aceptación)** |la propiedad se visualisa en los resultados de busqueda de los huespedes|

| Secuencia Normal (Camino feliz) | Excepciones / Alternativas |
|---|---|
| 1.  |el anfrition selecciona "publicar propiedad"   |
| 2.  |el sistema muestra un formulario de carga  |
| 3.  |el anfrition ingresa fotos, descripcion y precio  |3.1 si faltan datos obligatorios el sitema marca los campos en rojo y no permite avanzar| 
| 4. |el anfrition confirma la publicacion | 
...
|---|---|
| **Actor principal** |anfrition |
| **Descripción** |permite al anfrition modificar el calendario de sus propiedades |
| **Precondiciones** |el anfrition debe tener al menos una propiedad publicada|
...
| Secuencia Normal (Camino feliz) | Excepciones / Alternativas |
|---|---|
| 1.  |el anfrition selecciona la propiedad que desea gestionar  |
| 2.  |el sistema muestra el calendario de disponibilidad de dicha propiedad  | 
| 3.  |el anfrition selecciona un rango de fechas o dias| 
| 4. |el anfrition elige la accion (marcar como no disponible o liberar fechas) | 
| 5. |el anfriton presiona guardar cambios | 
| 6. |el sistema valida que no existan reservas confirmadas de esas fechas | 6.1 |si hay una reserva confirmada en las fechas seleccionadas, els sitema inpide el bloqueo y informa al anfrition  | 
